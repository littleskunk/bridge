...
const DEFAULTS = {
  ...
  server: {
    ...
    corsRegex: '^https?://(\\w{1,63}\\.){0,6}?storj\\.io$'
  },
  complex: {
  ...
  application: {
    ...
    publishTotal: 20, // number of farmers to publish in active pool
    publishBenchTotal: 5, // number of farmers to publish in bench pool
